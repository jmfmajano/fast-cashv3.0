            ...
            <div class="panel-heading">
              ...
              <div class="row" style="padding-left: 50px; padding-right: 50px;">
                <div class="col-md-12 text-center">
                    <form class="form-inline" id="buscrPorFecha" method="post" action="<?= base_url() ?>Contabilidad/DetalleLibroMayor">
                      <div class="margn">
                        ...
                        <a href="<?= base_url();?>Contabilidad/LibroMayor" class="btn btn-warning refres"><i class="fa fa-refresh"></i></a>
                      </div>
                    </form>
                  </div>
              </div> <br>  
